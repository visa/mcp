...
Complete working examples demonstrating how to use the **[@vic/mcp-client](../../packages/mcp-client)** package for integrating with VIC MCP server.

## 📖 What This Is

This package contains example code and workflows that demonstrate:

- How to connect to VIC MCP server using `@vic/mcp-client`
...
### "Cannot find module '@vic/mcp-client'"
...
- **MCP Client API**: See [@vic/mcp-client README](../../packages/mcp-client/README.md)
- **Token Management**: See [@vic/token-manager README](../../packages/token-manager/README.md)
